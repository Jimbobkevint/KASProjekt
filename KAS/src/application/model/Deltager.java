...
public class Deltager extends Person {
	...
	public Deltager(String navn, String tlfnr, String email,String adresse, String firmaNavn, String firmaTlfnr, String landBy, Ledsager ledsager) {
		super(navn, tlfnr, email);
		this.setAdresse(adresse);
		this.setFirmaNavn(firmaNavn);
		this.setFirmaTlfnr(firmaTlfnr);
		this.setLandBy(landBy);
		this.setLedsager(ledsager);
	}
