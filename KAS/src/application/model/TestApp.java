...
public class TestApp {
	...
	public static void main(String[] args) {
		...
		Deltager d1 = Service.createDeltager("Finn Madsen", "", "", "", "", "", "", null);
		Deltager d2 = Service.createDeltager("Niels Petersen", "", "", "", "", "", "", null);
		Deltager d3 = Service.createDeltager("Peter Sommer", "", "", "", "", "", "", null);
		Deltager d4 = Service.createDeltager("Lone Jensen", "", "", "", "", "", "", null);
		...
		Hotel h1 = Service.createHotel("Den Hvide Svane", "Strandvej 1", 1050, 1250, 7, p2.getTlfnr(), p2);
